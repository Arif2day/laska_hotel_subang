...
<head>
    ...
    <title>LASKA HOTEL SUBANG - Login</title>
...
background-image: linear-gradient(135deg, #d4a373 0%, #a87f58 50%, #7d5939 100%);
                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">LASKA HOTEL LOGIN!</h1>
                                    </div>
                                    <form class="user">
