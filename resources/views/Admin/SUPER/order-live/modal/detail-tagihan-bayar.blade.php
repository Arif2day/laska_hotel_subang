...
<div class="modal fade" id="detailModal" tabindex="-1">
  ...
  <div class="modal fade" id="readyModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Order Siap Dihidangkan</h5>
          <button type="button" class="close" data-dismiss="modal">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <p>Yakin ingin mengupdate status order menjadi siap dihidangkan?</p>
          <form id="readyForm">
            @csrf
            <input type="hidden" name="order_id" id="ready_order_id">
            <button type="submit" class="btn btn-success">Ya, Update Status Order</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="doneModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Mark Order as Done</h5>
          <button type="button" class="close" data-dismiss="modal">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <p>Yakin ingin mengupdate status order menjadi selesai?</p>
          <form id="doneForm">
            @csrf
            <input type="hidden" name="order_id" id="done_order_id">
            <button type="submit" class="btn btn-success">Ya, Update Status Order</button>
          </form>
        </div>
      </div>
