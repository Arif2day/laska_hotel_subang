...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Riwayat Order</h1>
    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-xs">
                        ...
                        <input type="hidden" id="urllist" name="urllist" value="{{url('order/riwayat/list')}}">
                        <input type="hidden" id="urldel" name="urldel" value="{{url('order/riwayat')}}">                        
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('Admin.SUPER.order-riwayat.modal.detail-tagihan-bayar')
</div>
@endsection
@section('script')
<script>
